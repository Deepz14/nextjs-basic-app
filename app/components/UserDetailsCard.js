        ...
        <div className="border border-gray-300 mt-8">
            ...
            <div className="mt-3 px-2">
                ...
                <div className="pl-1 py-2">
                    ...
                    <p>{userInfo.bio}</p>
                    <div className="my-2">
                        <UserCardLinks info={[{key: 'followers', followers}, {key: 'following', following}]}>
                        ...
                        {
                            location && <UserCardLinks info={[{key: 'location', location}]}>
                        ...
                        {
                            email && <UserCardLinks info={[{key: 'email', email}]}> 
                                <svg viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                        ...
                        {
                            blog && <UserCardLinks info={[{key: 'blog', blog}]}>
                        ...
                        {
                            public_repos && <UserCardLinks info={[{key: 'public repos', public_repos}]}>
